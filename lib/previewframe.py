...
def main():
    ...
    parser.add_argument('-m', dest='mainfile', default=None,
    ...
    parser.add_argument('-c', dest='compiler', default='pdflatex -synctex=1 -interaction=nonstopmode -shell-escape',
    ...
    parser.add_argument('-x', dest='hack_synctex', action='store_true', help='habilita hack do synctex para voltar ao arquivo original')
