    ...
    domyrewrap: function (joinonly) {
        ...
        if (hasSelection) {
            ...
            while (toLine < e.get_number_lines() - 1 &&
                ...
                (isComment === f.comment_line(e.get_line_text(toLine + 1)))) ++toLine;
        }
...
exports.createRewrapperForVSCode = function(vscode) {
...
exports.RewrappingTools = RewrappingTools;
exports.format_helper_for_latex = format_helper_for_latex;
